...
public class MyBarras extends Frame implements ActionListener{
 private Barras B;
...
// Frame dummyF;
 ...
 public MyBarras(int data[]){
  setTitle("MyBarras.class"+data.length);
...
//  System.out.print("hvjhfjekjklj,");
  setVisible(true);
 }//end MyBarras(int data[])
 
 public MyBarras(int data[],int intIntento){
  setTitle("MyBarras.class "+intIntento);
  setLayout(new FlowLayout());
  dato=data;
  addWindowListener(new WindowAdapter(){
   public void windowClosing(WindowEvent e){//4/5 WindowListener 
